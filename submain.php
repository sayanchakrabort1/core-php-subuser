...
$sql_e = "SELECT * FROM `registered_user` WHERE id=$parent";

$result = $conn->query($sql_e);

        while($row = $result->fetch_assoc()) {
        $adminMail=$row["email"];
        $adminMail=substr($adminMail, 22);
    }
...
<body>
    ...
    <h2 class="container commonSpace"> You are a sub user of <?php echo $adminMail ?></h2>
